...
class CSNet_single(nn.Module):
    ...
    def __init__(self, dim, n, classes= 6, scale=1, depth=5, initial_channels=64, normalization=True):
        ...
        self.unet = cs_unet.UNet(in_channels=n, out_channels_reg=dim * n, out_channels_seg= classes * n, dim=dim,
