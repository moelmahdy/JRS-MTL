...
class SEDDNet(nn.Module):
    '''
    Single Encoder Double Decoder  CNN for joint registration and segmentation method.
    Parameters
    ----------
    dim : int
    ...
    def __init__(self, in_channels, dim=3, classes= 5, depth=3, initial_channels=64, channels_list = None):
        ...
        self.unet = sedd_unet.UNet(in_channels=in_channels, out_channels_seg= classes, dim=dim,
